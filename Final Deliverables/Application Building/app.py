...
#load model
app = Flask(__name__)
model = pickle.load(open("C:/Users/Nithish/Desktop/IBM-Project-20466-1659720228-main/Final Deliverables/Application Building/phishing_model.pkl", 'rb'))
...
def y_predict():
    ...
    print(output)
    if(output==1):
        pred="The Website is Legal and Clear. It is Safe. Happy Surfing!!"
